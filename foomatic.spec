...
* Wed Mar  3 2010 Tim Waugh <twaugh@redhat.com> - 4.0.3-10
...
- Fix for handling integer options (bug #556871).

* Tue Dec 15 2009 Tim Waugh <twaugh@redhat.com> - 4.0.3-8
- Really fixed installation path for perl module (bug #547702).
